...
public String connect(String con) {
       String ss = null;
        if (con.equals("017")) {
            ...
            ImageIcon icon = new ImageIcon("F:\\JSP\\dtasjd\\src\\mobileInfoManagementsystem\\Images\\funny.png");
    ...
    public ImageIcon setImagelogo(String opDigit) {
        ...
        if (opDigit.equals("017")) {
            ...
            ii = new ImageIcon("F:\\JSP\\dtasjd\\src\\mobileInfoManagementsystem\\Images\\rb.jpg");
            Image im = ii.getImage();
            Image newimage = im.getScaledInstance(80, 80, Image.SCALE_SMOOTH);
            newimageIcon = new ImageIcon(newimage);
        } else if (opDigit.equals("019")) {
            ii = new ImageIcon("F:\\JSP\\dtasjd\\src\\mobileInfoManagementsystem\\Images\\bl.PNG");
            Image im = ii.getImage();
            Image newimage = im.getScaledInstance(80, 80, Image.SCALE_SMOOTH);
            newimageIcon = new ImageIcon(newimage);
        } else if (opDigit.equals("016")) {
            ii = new ImageIcon("F:\\JSP\\dtasjd\\src\\mobileInfoManagementsystem\\Images\\art.PNG");
            ...
            ii = new ImageIcon("F:\\JSP\\dtasjd\\src\\mobileInfoManagementsystem\\Images\\tt.PNG");
            Image im = ii.getImage();
            Image newimage = im.getScaledInstance(80, 80, Image.SCALE_SMOOTH);
           newimageIcon = new ImageIcon(newimage);
        }
