...
public class Approveto_Enter extends javax.swing.JFrame {
  ...
  @SuppressWarnings("unchecked")
    ...
    private void cmdregActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdregActionPerformed
       String gender=null;
        if (txtpassreg.getPassword().length == 10) {
            JOptionPane.showMessageDialog(null, "password must be 1-10 !!", "Forme", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
       ...
       try {
           ...
           result=pst.executeQuery();
            if (result.next()&& checkemp.isSelected()) {
                JOptionPane.showMessageDialog(null, "The usrebane abd password was succassfully varified");
